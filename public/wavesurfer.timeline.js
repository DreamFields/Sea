 ...
 * @property {string} unlabeledNotchColor='#fff' The colour of the notches
 * that do not have labels
 * @property {string} primaryColor='#fff' The colour of the main notches
 * @property {string} secondaryColor='#fff' The colour of the secondary
 * notches
